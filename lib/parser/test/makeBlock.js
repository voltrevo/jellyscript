...
generator('braceBlock', braceBlock, {
  valid: [
    ...
    [
      '{a string shouldnt mess up the balance though, ' +
      'so this is allowed: \'}\'}',
...
generator('parenthesesBlock', parenthesesBlock, {
  valid: [
    ...
    ['((begin and end blocks (must) be (balanced)))'],
    ['(a string shouldnt mess up the balance though, so this is allowed: \')\')'],
...
generator('beginEndBlock', beginEndBlock, {
  valid: [
    ...
    ['begin a string shouldnt mess up the balance though, so this is allowed: \'end\' end'],
    [
